...
*/
        ...
        this.update = function(options) {
            if (calendar._disposed) {
                throw new DayPilot.Exception("This DayPilot.Gantt instance has been disposed.");
            }
        ...
        wrap.translate = function() {
            ...
            if (DayPilot.isArray(calendar.columns)) {
                ...
                for (var i = 0; i < calendar.columns.length; i++) {
                    ...
                    var rhc = {};
                    DayPilot.Util.copyProps(c, rhc, ['html', 'text', 'name', 'title', 'width', 'hidden']);
            ...
            scheduler.onBeforeRowHeaderRender = function(args) {
                ...
                args.row.useStandardColumns = DayPilot.isArray(calendar.columns);
